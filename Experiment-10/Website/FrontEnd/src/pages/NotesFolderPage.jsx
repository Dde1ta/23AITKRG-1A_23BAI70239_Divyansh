...
const handleCreateFolder = async (folderData) => {
    try {
       ...
       // 2. Use the REAL data returned by the backend (with the correct ID)
       const realFolder = response.data;
       
       // 3. Update state with the REAL folder
       setFolders([...folders, realFolder]); 
    } catch (err) {
       console.error(err);
    }
};
